...
const filePath = 'C:/Users/dave_/Sentinel cover/Templates/Comunidad de Madrid/DHHBWA_fillable (1).pdf';
...
async function analyze() {
    ...
    const outputPath = path.join(outputDir, 'DHHBWA_fillable_v2_fields.json');
    ...
    const diagPath = path.join(outputDir, 'DHHBWA_fillable_v2_DIAGNOSTIC.pdf');
